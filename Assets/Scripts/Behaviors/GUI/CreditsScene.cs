...
{
    /// <summary>
    /// Private members variables for the credits scene, the menu title and menuGUI
    /// </summary>
    ...
    /// <summary>
    /// Initializes the credits variables.
    ...
    void OnGUI()
    {
        GUI.Label(new Rect(Screen.width / 2 - 150, 25, 300, 100), "Credits Scene", menuTitle);
