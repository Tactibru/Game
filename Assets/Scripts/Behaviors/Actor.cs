...
public class Actor : MonoBehaviour 
{
	...
	void Update () 
    {
        ...
        if (!currentlyMoving)
        {
            if (Input.GetKeyDown("w") && currentMovePoint.North)
            {
            ...
            else if (Input.GetKeyDown("s") && currentMovePoint.South)
            {
            ...
            else if (Input.GetKeyDown("a") && currentMovePoint.West)
            {
            ...
            else if (Input.GetKeyDown("d") && currentMovePoint.East)
            {
